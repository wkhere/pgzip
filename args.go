...
const usage = `Usage: pgzip FLAGS] [FILE1] [FILE2]
    -z, --compress     compress (default true)
    -d, --decompress   decompress
    -N, --level=N      compress level, -2..9 (default %d)
    -f, --force        force overwriting FILE2
    -h, --help         show this help and exit
When compressing and only FILE1 is given, FILE2 is FILE1.gz .
When decompressing and only FILE1 is given, FILE2 tries to strip .gz from it.
